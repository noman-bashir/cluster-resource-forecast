...
_PREDICTORCONFIG_AVGPREDICTORCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="percentile",
            full_name="PredictorConfig.AvgPredictorConfig.percentile",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_PREDICTORCONFIG_MAXPREDICTORCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="percentile",
            full_name="PredictorConfig.MaxPredictorConfig.percentile",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
_PREDICTORCONFIG_NSIGMACONFIG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="percentile",
            full_name="PredictorConfig.NSigmaConfig.percentile",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
